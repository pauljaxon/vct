...
// csvdiff filename1 filename2
// 
// Only return list of those in filename1 that do not occur in filename2.
...
<< "Usage" << endl
<< "" << endl
<< "csvdiff filename1 filename2" << endl
<< "" << endl
<< "Only return list of those records in filename1 that do not " << endl
